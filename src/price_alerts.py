...
Supports complex alert conditions and virtual portfolio tracking.
"""
...
class PriceAlertManager:
    ...
    def _check_alerts(self):
        ...
        prices = self._get_current_prices(all_symbols)
        if not prices:
            return
    ...
    def _get_tradingview_link(self, symbol):
        ...
        # Use a default chart layout
        chart_id = "ENQ6RrtR"
        
        # Format the symbol for TradingView (BINANCE:BTCUSDT format)
        tv_symbol = f"BINANCE%3A{base_symbol}USD"
        
        return f"https://www.tradingview.com/chart/{chart_id}/?symbol={tv_symbol}"
    ...
    def _trigger_alert(self, alert, prices):
        ...
        if len(alert.conditions) == 1:
            ...
            chart_link = self._get_tradingview_link(first_symbol)
...
def cmd_analyze_ai(args, bot, user_id=None):
    """
